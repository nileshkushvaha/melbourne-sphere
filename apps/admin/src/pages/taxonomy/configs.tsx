...
export const AREAS_CONFIG: TermsPageConfig = {
  ...
  fields: [
    ...
    { name: 'eligibilitySource', label: 'How this area was verified', input: 'text', max: 255, placeholder: 'e.g. City of Melbourne suburb list', help: 'Where the boundary came from. Saving records the time.' },
    sortOrder,
