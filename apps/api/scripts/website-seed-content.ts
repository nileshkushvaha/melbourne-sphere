...
export const SEED_TESTIMONIALS: SeedTestimonial[] = [
  { name: 'Marika Stevens', relationship: 'Owner, Lygon Lane Espresso', business: 'lygon-lane-espresso', quote: 'We had a website nobody could find and a Google listing with the wrong hours. Within a month of being on Melbourne Sphere we were getting people through the door who said they found us here. The editors actually checked our details with us first, which nobody else does.' },
  { name: 'Daniel Okonkwo', relationship: 'Owner, Kensington Plumbing & Gas', business: 'kensington-plumbing-and-gas', quote: 'Most directories sell you a package and then sell your competitor a better one. This one just lists you properly. Half our new work in winter came through the listing.' },
  ...
  { name: 'Reuben Clarke', relationship: 'Owner, Bay Street Fish Market', business: 'bay-street-fish-market', quote: 'My father ran this shop for thirty years without a website. The listing was written in an afternoon, the photographs are honest, and it has brought us a new generation of customers from across the river.' },
  ...
  { name: 'Tom Whelan', relationship: 'Owner, Errol Street Barbers', business: 'errol-street-barbers', quote: 'A customer told me she picked us because the review said we were good with nervous kids. That review went up because somebody read it first and checked it was fair. That matters to a small shop.' },
  ...
  { name: 'Peter Lawson', relationship: 'Owner, Flinders Lane Books', business: 'flinders-lane-books', quote: 'We have been on Flinders Lane since 1998 and have watched a lot of listing sites come and go. This is the first one that asked what we actually do before writing about us.' },
  ...
  { name: 'Julian Marsh', relationship: 'Owner, Harbour Kitchen', business: 'harbour-kitchen-docklands', quote: 'We are in Docklands, which people write off before they have been. Having a proper area page with our listing on it has genuinely changed who walks in on a weeknight.' },
