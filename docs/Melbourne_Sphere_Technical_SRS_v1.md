...
Version 1.0 • 5 September 2026 • MVP baseline
...
**RBAC 001 —** Define permissions by resource and action: listings.read/write/publish, taxonomy.manage, reviews.moderate, comments.moderate, reports.manage, enquiries.read/manage, posts.write/publish, media.manage, settings.manage, admins.manage and audit.read. Store roles, permissions and joins; seed one Super Admin role. NestJS guards enforce permissions and object/state constraints for every admin endpoint \[R5\]. Hiding buttons is not authorization.
...
| AdminUser                       | email, passwordHash, active, encryptedTotpSecret                                                     | Unique normalized email; never used as public author data |
| Role and Permission             | stable key, description                                                                              | AdminRole and RolePermission composite unique joins       |
