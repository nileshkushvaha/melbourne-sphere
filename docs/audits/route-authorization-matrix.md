...
> **Superseded on 8 September 2026** by `api-authorization-matrix.md`, which is
> generated by `pnpm --filter api routes:matrix` rather than by hand. This file
> is kept as the record of the 7 September closure; it is not maintained.
